...
import { Button, StyleSheet, Text, TouchableOpacity, TextInput, View, Image, Platform } from 'react-native';
...
export default function OrderScreen({ navigation }) {
  ...
  return (
    <View
      ...
      >
        <Text style={globalStyles.loginText}>Schedule a notification</Text>
      </TouchableOpacity>
    </View>
  );
}
